...
<details>
  <summary>Назовите наиболее важные команды Docker</summary><br> 
      <li>build, сборка образа для Docker</li>
      <li>create, создание нового контейнера</li>
      <li>kill. принудительная остановка контейнера</li>
      <li>dockerd, запуск сервиса Docker</li>
      <li>commit, создание нового образа из изменений в контейнере</li>
 </details>
<details>
